...
<h4> Позитивный сценарий заполнения формы </h4>  
  1. Заполнить валидными данными поле Имя (Ввести любого типа данные  без использования цифр и спец. символов содержащие ваше имя в поле имя).
  2. Заполнить валидными данными поле Номер телефона (под валидным понимается номер, в в формате +9 (999) 999-99-99).
  3. Кликнуть кнопку <strong> Записаться </strong>.
